                        ...
                        <div class="flex flex-col h-60">
                            <div
                                ...
                                <div class="mt-4">
                                    ...
                                    <DatePicker v-model="form.birth_date" showIcon fluid required dateFormat="dd-mm-yy"
                                        class="rounded-xl border-2 mt-1 block" :showOnFocus="false"
                        ...
                        <div class="flex flex-col h-fit">
                            <div
                                ...
                                <div class="mt-4">
                                    ...
                                    <Select v-model="form.state" :options="states" optionValue="name" optionLabel="name"
                                        required placeholder="Select a State" class="mt-1 block w-full" />
                                    <InputError class="mt-2" :message="form.errors.state" />
                                </div>
                                <div class="mt-4">
                                    <InputLabel for="state" value="City" />
                                    <Select v-model="form.city" :options="states" optionValue="name" optionLabel="name"
                                        required placeholder="Select a City" class="mt-1 block w-full" />
                                    <InputError class="mt-2" :message="form.errors.city" />
                                </div>
                                <div class="mt-4">
                                    <InputLabel for="state" value="Street" />
                                    <InputText v-model="form.street" placeholder="Street (optional)"
                    ...
                    <StepPanel v-slot="{ activateCallback }">
                        <div class="flex flex-col h-fit">
                            <div
                                class="px-10 border-surface-200 dark:border-surface-700 rounded bg-surface-50 dark:bg-surface-950 flex-auto flex flex-col justify-center items-stretch font-medium">
                                <div class="mt-4">
                                    <InputLabel for="state" value="Postal code" />
